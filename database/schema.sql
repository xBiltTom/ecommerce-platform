...
-- Insertar Productos
INSERT INTO productos (sku, nombre, slug, descripcion, precio, precio_oferta, stock_fisico, stock_reservado, stock_minimo, categoria_id, marca_id, imagen_url) VALUES
('APP-MBP-14', 'MacBook Pro 14"', 'macbook-pro-14', 'Chip M3 Pro, 16GB RAM, 512GB SSD', 1999.00, 1699.15, 50, 0, 5, (SELECT id FROM categorias WHERE slug='laptops'), (SELECT id FROM marcas WHERE slug='apple'), 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=800&q=80'),
('APP-IPH-15P', 'iPhone 15 Pro', 'iphone-15-pro', 'Titanio, A17 Pro, 256GB', 1099.00, NULL, 100, 0, 10, (SELECT id FROM categorias WHERE slug='smartphones'), (SELECT id FROM marcas WHERE slug='apple'), 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?auto=format&fit=crop&w=800&q=80'),
('SAM-S24-U', 'Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'Snapdragon 8 Gen 3, 256GB, 12GB RAM', 1299.00, NULL, 80, 0, 10, (SELECT id FROM categorias WHERE slug='smartphones'), (SELECT id FROM marcas WHERE slug='samsung'), 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?auto=format&fit=crop&w=800&q=80'),
('SON-WH1000XM5', 'Sony WH-1000XM5', 'sony-wh-1000xm5', 'Audífonos inalámbricos con cancelación de ruido', 349.00, 296.65, 150, 0, 20, (SELECT id FROM categorias WHERE slug='audio'), (SELECT id FROM marcas WHERE slug='sony'), 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?auto=format&fit=crop&w=800&q=80'),
('LG-OLED-65', 'LG OLED TV 65" C3', 'lg-oled-tv-65-c3', 'Smart TV 4K UHD, 120Hz', 1599.00, NULL, 30, 0, 5, (SELECT id FROM categorias WHERE slug='televisores'), (SELECT id FROM marcas WHERE slug='lg'), 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=800&q=80'),
('ASU-ROG-G15', 'Asus ROG Strix G15', 'asus-rog-strix-g15', 'Ryzen 9, RTX 4070, 16GB RAM, 1TB SSD', 1499.00, NULL, 40, 0, 5, (SELECT id FROM categorias WHERE slug='laptops'), (SELECT id FROM marcas WHERE slug='asus'), 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?auto=format&fit=crop&w=800&q=80'),
('APP-IPAD-PRO', 'iPad Pro 12.9"', 'ipad-pro-12-9', 'Chip M2, Pantalla Liquid Retina XDR', 1099.00, 934.15, 60, 0, 10, (SELECT id FROM categorias WHERE slug='tablets'), (SELECT id FROM marcas WHERE slug='apple'), 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&w=800&q=80'),
('SAM-TAB-S9', 'Samsung Galaxy Tab S9', 'samsung-galaxy-tab-s9', 'AMOLED 11", Snapdragon 8 Gen 2', 799.00, NULL, 75, 0, 10, (SELECT id FROM categorias WHERE slug='tablets'), (SELECT id FROM marcas WHERE slug='samsung'), 'https://images.unsplash.com/photo-1589739900266-43b2843f4c12?auto=format&fit=crop&w=800&q=80'),
('APP-AW-U2', 'Apple Watch Ultra 2', 'apple-watch-ultra-2', 'Caja de titanio de 49mm, resistente al agua', 799.00, NULL, 40, 0, 5, (SELECT id FROM categorias WHERE slug='smartwatches'), (SELECT id FROM marcas WHERE slug='apple'), 'https://images.unsplash.com/photo-1434493789847-2902a52dda56?auto=format&fit=crop&w=800&q=80'),
('SAM-GW-6', 'Samsung Galaxy Watch 6', 'samsung-galaxy-watch-6', 'Monitoreo avanzado de salud y sueño', 299.00, 254.15, 90, 0, 10, (SELECT id FROM categorias WHERE slug='smartwatches'), (SELECT id FROM marcas WHERE slug='samsung'), 'https://images.unsplash.com/photo-1579586337278-3befd40fd17a?auto=format&fit=crop&w=800&q=80'),
('BOS-QC-ULTRA', 'Bose QuietComfort Ultra', 'bose-qc-ultra', 'Cancelación de ruido de clase mundial', 429.00, NULL, 120, 0, 15, (SELECT id FROM categorias WHERE slug='audio'), (SELECT id FROM marcas WHERE slug='bose'), 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=800&q=80'),
('JBL-FLIP-6', 'JBL Flip 6', 'jbl-flip-6', 'Parlante Bluetooth portátil a prueba de agua', 129.00, NULL, 200, 0, 30, (SELECT id FROM categorias WHERE slug='audio'), (SELECT id FROM marcas WHERE slug='jbl'), 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?auto=format&fit=crop&w=800&q=80'),
('XIA-14-PRO', 'Xiaomi 14 Pro', 'xiaomi-14-pro', 'Lentes Leica, Snapdragon 8 Gen 3', 899.00, NULL, 65, 0, 10, (SELECT id FROM categorias WHERE slug='smartphones'), (SELECT id FROM marcas WHERE slug='xiaomi'), 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=800&q=80'),
('DEL-XPS-15', 'Dell XPS 15', 'dell-xps-15', 'Intel Core i9, 32GB RAM, Pantalla OLED 4K', 2199.00, NULL, 25, 0, 5, (SELECT id FROM categorias WHERE slug='laptops'), (SELECT id FROM marcas WHERE slug='dell'), 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=800&q=80'),
('LEN-LEG-5', 'Lenovo Legion 5 Pro', 'lenovo-legion-5-pro', 'Ryzen 7, RTX 4060, 16GB RAM', 1399.00, NULL, 45, 0, 5, (SELECT id FROM categorias WHERE slug='laptops'), (SELECT id FROM marcas WHERE slug='lenovo'), 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&w=800&q=80'),
('HP-OMEN-16', 'HP Omen 16', 'hp-omen-16', 'Intel Core i7, RTX 4070, Pantalla 165Hz', 1599.00, NULL, 35, 0, 5, (SELECT id FROM categorias WHERE slug='laptops'), (SELECT id FROM marcas WHERE slug='hp'), 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?auto=format&fit=crop&w=800&q=80'),
('LG-ULTRAGEAR-27', 'LG UltraGear 27"', 'lg-ultragear-27', 'Monitor Gaming QHD 165Hz Nano IPS', 399.00, NULL, 80, 0, 10, (SELECT id FROM categorias WHERE slug='monitores'), (SELECT id FROM marcas WHERE slug='lg'), 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=800&q=80'),
('SAM-ODYSSEY-G7', 'Samsung Odyssey G7 32"', 'samsung-odyssey-g7', 'Monitor Curvo 1000R, QHD 240Hz', 699.00, NULL, 40, 0, 5, (SELECT id FROM categorias WHERE slug='monitores'), (SELECT id FROM marcas WHERE slug='samsung'), 'https://images.unsplash.com/photo-1586227740560-8cf2732c1531?auto=format&fit=crop&w=800&q=80'),
('SON-BRAVIA-75', 'Sony Bravia XR 75"', 'sony-bravia-xr-75', 'Mini LED 4K HDR Smart TV', 2499.00, NULL, 15, 0, 3, (SELECT id FROM categorias WHERE slug='televisores'), (SELECT id FROM marcas WHERE slug='sony'), 'https://images.unsplash.com/photo-1552831388-6a0b35077328?auto=format&fit=crop&w=800&q=80'),
('APP-AIRPODS-PRO', 'AirPods Pro 2', 'airpods-pro-2', 'Audio espacial y cancelación de ruido activa', 249.00, NULL, 300, 0, 50, (SELECT id FROM categorias WHERE slug='audio'), (SELECT id FROM marcas WHERE slug='apple'), 'https://images.unsplash.com/photo-1606220588913-b3aecb492097?auto=format&fit=crop&w=800&q=80')
